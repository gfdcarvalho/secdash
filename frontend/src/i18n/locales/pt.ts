export const pt = {
    ...
    csvExport: {
        button: "Exportar CSV",
        vulnReportTitle: "SecDash - Relatório de Vulnerabilidades",
        sastReportTitle: "SecDash - Relatório de Alertas SAST",
        generatedAt: "Gerado em",
        repository: "Repositório",
        repositories: "Repositórios analisados",
        team: "Equipa",
        platform: "Plataforma",
        owner: "Proprietário",
        url: "URL",
        ...
        colPackage: "Pacote",
        colVersion: "Versão",
        colFixedVersion: "Versão corrigida",
        colCvssScore: "CVSS Score",
        colCve: "CVE",
        colManifestPath: "Manifesto",
        colDetectedAt: "Detetado em",
        colRuleId: "ID da regra",
        colRuleDescription: "Descrição da regra",
        colTool: "Ferramenta",
        colFile: "Ficheiro",
        colStartLine: "Linha inicial",
        colEndLine: "Linha final",
    },
    sastDetails: {
        loading: "A carregar...",
