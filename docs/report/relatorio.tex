...
\cleardoublepage
\chapter*{Resumo}
O \textbf{SecDash} é uma plataforma web de monitorização de relatórios de segurança que agrega e centraliza vulnerabilidades indentificadas por ferramentas externas, nomeadamente GitHub Dependabot e Code Scanning e GitLab SAST e Dependency Scanning, em diferentes repositórios. \\
...
Neste trabalho foram utilizadas ferramentas de inteligência artificial generativa, designadamente chatbots LLM como ChatGPT, Gemini e Claude Code para clarificação de conceitos teóricos e otimização de síntaxe, bem como para auxílio na criação de componentes visuais. \\
