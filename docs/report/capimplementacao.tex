...
A classe \textbf{BearerTokenAuthFilter} é um filtro é responsável por autenticar o utilizador em cada pedido HTTP e por estabelecer o contexto de segurança da aplicação. Ela extende a classe do Spring OncePerRequestFilter, garantindo assim que a sua execução ocorre apenas uma única vez por pedido. \\
