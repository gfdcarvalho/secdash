...
O método addUserTo adiciona o utilizador autenticado ao pedido HTTP para que as restantes camadas do sistema possam ter acesso a essa informação, e é usado pelo AuthenticationInterceptor e pelo BearerTokenAuthFilter.
