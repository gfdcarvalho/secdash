...
Nas subsecções seguintes é detalhada a estrutura interna do cliente Web. \\

\subsection{utils}
funçoes que vao auxiliar as views

\subsubsection{Custom Hooks}
<RequireAuthentication><Layout/></RequireAuthentication>, 
verifica se tamos loged in usando o autentication provider, caso contrar redirect p o login, fazendo pedido ao backend com token q temos no broas p /me
...
<RouterProvider router={router} /> é mesmo do react, n ta implementado em lado nenhum
